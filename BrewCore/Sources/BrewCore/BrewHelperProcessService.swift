...
public final class BrewHelperProcessService: BrewProcessServiceProtocol, ObservableObject {
    ...
    private let proxy: BrewProtocolService

    init() {
        let connection = BrewProtocolServiceXPCConnection(xpc: .service("io.harkema.BrewUIXPCService"))
        connection.resume()
...
extension InjectedValues {
    public var helperProcessService: BrewProcessServiceProtocol {
...
private struct BrewHelperProcessServiceKey: InjectionKey {
    static var currentValue: BrewProcessServiceProtocol = BrewHelperProcessService()
}
