...
public typealias BrewProtocolServiceXPCConnection = XPCConnection<BrewProtocolService, Never>
...
@objc(BrewProtocolServiceXPC) // important thing: obj-c protocol name should be the same on both sides of the connection
...
public extension XPCInterface {
    static var service: XPCInterface<BrewProtocolService, BrewProtocolServiceXPC> {
        let interface = NSXPCInterface(with: BrewProtocolServiceXPC.self)
...
private final class ServiceToXPC: NSObject, BrewProtocolServiceXPC {
    let instance: BrewProtocolService
    init(_ instance: BrewProtocolService) { self.instance = instance }
...
private struct ServiceFromXPC: BrewProtocolService {
    let proxy: BrewProtocolServiceXPC
