...
public extension BrewCommand {
  enum InfoCommand: Codable, Equatable, CommandString {
    case installed
  ...
  enum UpgradeCommand: Codable, Equatable, CommandString {
    case all
  ...
  enum ListCommand: Codable, Equatable, CommandString {
    case versions
